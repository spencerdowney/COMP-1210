...
public class ConicalFrustumList {
   ...
   */
   public ConicalFrustumList readFile(String fileNameIn) 
      ...
      while (scanFile.hasNext()) {
         ...
         myList.add(new ConicalFrustum(label, radius1, radius2, height));          
      }
      scanFile.close();
   ...
   */
   ...
   /**
   * @param labelIn the labelIn.
   * @param radius1In the radius1In.
   * @param radius2In the radius2In.
   * @param heightIn the heightIn. 
   * @return cf the cf.
   */
   public ConicalFrustum editConicalFrustum(String labelIn,
                      double radius1In, double radius2In, double heightIn) {
   
      ConicalFrustum cf = findConicalFrustum(labelIn);
      cf.setRadius1(radius1In);
      cf.setRadius2(radius2In);
      cf.setHeight(heightIn);
      return cf;
   }
}